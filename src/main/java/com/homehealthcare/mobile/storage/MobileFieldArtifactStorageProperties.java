package com.homehealthcare.mobile.storage;
...
@Component
@ConfigurationProperties(prefix = "app.mobile-artifacts")
public class MobileFieldArtifactStorageProperties {

    private Path localStorageDirectory = Paths.get(System.getProperty("java.io.tmpdir"), "homehealthcare", "mobile-artifacts");
